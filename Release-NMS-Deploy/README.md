...
| [`build-scripts/Set-SourceRef.ps1`](build-scripts/Set-SourceRef.ps1) | Point the checkout at a pull request, branch, tag or commit — or back at the default branch. Switches source only; builds nothing. |
