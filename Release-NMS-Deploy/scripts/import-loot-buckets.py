...
Does not write into a migration. Apply the seed after custom v33 creates empty tables.
...
def main() -> int:
    ...
    lines = [
        ...
        "-- Apply AFTER custom migration v33 (empty nms_loot_buckets* tables). Not a migration.",
