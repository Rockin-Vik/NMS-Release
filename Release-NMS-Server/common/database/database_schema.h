...
namespace DatabaseSchema {
	...
	static std::map<std::string, std::string> GetCharacterTables()
	{
		return {
			...
			{"character_learned_discs",        "character_id"},
			{"character_learned_mem",          "character_id"},
			{"character_learned_spells",       "character_id"},
			...
			{"character_pet_command_states",    "character_id"},
			...
			{"nms_waypoints_character",        "character_id"},
			{"timers",                         "char_id"},
			{"trader",                         "char_id"},
			{"zone_flags",                     "charID"}
		};
	...
	static std::vector<std::string> GetPlayerTables()
	{
		return {
			...
			"spell_buckets",
			"spell_globals",
			"nms_waypoints_account",
			"nms_waypoints_character",
			"timers",
			"trader",
			"trader_audit",
			"zone_flags"
	...
	static std::vector<std::string> GetContentTables()
	{
		return {
			...
			"tasksets",
			"nms_waypoints",
			"nms_waypoints_categories",
			"nms_waypoints_default",
			"tradeskill_recipe",
