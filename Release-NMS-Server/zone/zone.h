...
public:
	...
	void HandlePermanentServerBuffs();
	...
	// Waypoints
	std::vector<NmsWaypointsRepository::NmsWaypoints>& GetAllWaypoints(bool force_reload = true);
	const NmsWaypointsRepository::NmsWaypoints* WaypointGetSpawn(std::string zone_shortname);
...
private:
	...
	// Waypoints
	std::vector<NmsWaypointsRepository::NmsWaypoints> m_all_waypoints = { };
