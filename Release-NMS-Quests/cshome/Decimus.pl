...
sub EVENT_SAY {
    ...
    if ($text=~/hail/i) {   
        ...
        $response = "In exchange for five [Emperor's Favor], I can enchant the entire world! Each should co-exist with other versions of this type of effect, and will last four hours. If the world is already enchanted in this way, purchasing additional enhancement will extend the duration of the current enchantment. Would you like to bestow the [Favor of Experience], [Favor of Aegolism] (Hit Points & AC), [Favor of Focus] (Combat Statistics), [Favor of Selo] (Movement Speed), [Favor of Koadic] (Mana Regeneration), [Favor of the Brood] (Attack Speed), or [Favor of the Grove] (Health Regeneration)? Alternatively, for twenty-five tokens of the Emperor's favor, I can cast [all of these enchantments]!";
    }
    ...
    elsif ($text=~/hit points and armor class|favor of aegolism/i) {
        my $buff_id = 43003;
        if (ApplyWorldWideBuff($buff_id)) {
            $response = "Excellent! Your fellow adventurers will appreciate this!";
            $ww_buff = 1;
    ...
    elsif ($text=~/combat statistics|favor of focus/i) {
        my $buff_id = 43004;
        if (ApplyWorldWideBuff($buff_id)) {
            $response = "Excellent! Your fellow adventurers will appreciate this!";
            $ww_buff = 1;
    ...
    elsif ($text=~/mana regeneration|favor of koadic/i) {
        my $buff_id = 43006;
        if (ApplyWorldWideBuff($buff_id)) {
            $response = "Excellent! Your fellow adventurers will appreciate this!";
            $ww_buff = 1;
    ...
    elsif ($text=~/attack speed|favor of the brood/i) {
        my $buff_id = 43007;
        if (ApplyWorldWideBuff($buff_id)) {
            $response = "Excellent! Your fellow adventurers will appreciate this!";
            $ww_buff = 1;
    ...
    elsif ($text=~/health regeneration|favor of the grove/i) {
        my $buff_id = 43008;
        if (ApplyWorldWideBuff($buff_id)) {
            $response = "Excellent! Your fellow adventurers will appreciate this!";
            $ww_buff = 1;
