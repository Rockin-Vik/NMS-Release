...
sub EVENT_SAY {
    ...
    if ($text =~ /hail/i) {
        ...
        $response = "In exchange for a number of [Emperor's Favor], I can enchant the entire world! Each should co-exist with over versions of this type of effect, and will last four hours.
                     ...
                     In order to enhance [Experience Gain] or [Movement Speed], I will require five tokens of the Emperor's favor. 
                     Enhancement of [Overall Power] will cost 20 tokens of the Emperor's favor. 
                     For merely ten tokens of the Emperor's favor, I can [influence the tides of fate] in order to increase the rate that adventurers find rare items in the world!
